...
class Newsletter extends PureComponent {
  constructor(props, context) {
    ...
    this.successCallbackSubscription = this.successCallbackSubscription.bind(
      this
    )
  ...
  successCallbackSubscription(/* result*/) {
    this.props.flash(
      this.context.intl.formatMessage({ id: 'newsletter.success_message' }),
      'success'
    )
    this.dismissBanner()
  }
    ...
    return (
      <Formsy.Form className="newsletter-form" onSubmit={this.subscribeEmail}>
        <Input
          ...
          layout="elementOnly"
        />
        <Button className="newsletter-button" type="submit" bsStyle="primary">
