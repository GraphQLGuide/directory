  ...
  return (
    <div className="posts-stats">
      ...
      <span className="posts-stats-item" title="Upvotes">
        <Components.Icon name="upvote" /> {post.baseScore || 0}{' '}
        <span className="sr-only">Upvotes</span>
      </span>
      <span className="posts-stats-item" title="Clicks">
        <Components.Icon name="clicks" /> {post.clickCount || 0}{' '}
        <span className="sr-only">Clicks</span>
      </span>
      <span className="posts-stats-item" title="Views">
        <Components.Icon name="views" /> {post.viewCount || 0}{' '}
